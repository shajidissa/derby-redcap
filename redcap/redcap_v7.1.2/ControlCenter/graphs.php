...
$(function() {
	...
	// Chart 11
	$.get(ccstats, { plottime: plottime, chartid: 'chart11'}, function(data) { $('#chart11').html(''); eval(data);
		// Chart 10
		$.get(ccstats, { plottime: plottime, chartid: 'chart10'}, function(data) { $('#chart10').html(''); eval(data);
			// Chart 4
