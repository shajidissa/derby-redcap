...
if ($isAjax && isset($_POST['visible']) && isset($_POST['val_type']))
{
	...
	{
		// Log the event
		Logging::logEvent($sql,"redcap_validation_types","MANAGE",$_POST['val_type'],"validation_name = '" . prep($_POST['val_type']) . "'","Modify field validation settings");
...
else
{
	...
	<h4 style="margin-top: 0;"><?php echo RCView::img(array('src'=>'validated.png')) . $lang['control_center_150'] ?></h4>
