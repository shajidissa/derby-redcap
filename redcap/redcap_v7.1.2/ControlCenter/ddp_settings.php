...
<h4 style="margin-top: 0;"><?php echo RCView::img(array('src'=>'databases_arrow.png')) . $lang['ws_63'] ?></h4>
...
<tr>
	...
	<td class="cc_data">
		...
		<input class='x-form-text x-form-field' type='text' style='width:25px;' maxlength='3' onblur="redcap_validate(this,'1','999','hard','int');"  name='realtime_webservice_data_fetch_interval' value='<?php echo htmlspecialchars($element_data['realtime_webservice_data_fetch_interval'], ENT_QUOTES) ?>' />
		<span class="cc_info" style="font-weight:bold;color:#000;">
...
<tr>
	...
	<td class="cc_data">
		<input class='x-form-text x-form-field' type='text' style='width:25px;' maxlength='3' onblur="redcap_validate(this,'1','100','hard','int');" name='realtime_webservice_stop_fetch_inactivity_days' value='<?php echo htmlspecialchars($element_data['realtime_webservice_stop_fetch_inactivity_days'], ENT_QUOTES) ?>' />
		<span class="cc_info" style="font-weight:bold;color:#000;">
