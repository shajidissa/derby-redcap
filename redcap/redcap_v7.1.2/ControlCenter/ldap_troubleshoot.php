...
function loginFunctionLdap($username = null, $status = null, &$auth = null)
{
	echo   "<p>
				...
				<a target='_blank' href='https://community.projectredcap.org/articles/695/setting-up-ldap-authentication-in-redcap-1.html' style='text-decoration:underline;'>LDAP setup page</a> on the REDCap wiki.
			</p>";
