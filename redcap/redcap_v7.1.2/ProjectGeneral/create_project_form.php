...
$(function(){
	...
	<?php if (!$enable_projecttype_singlesurvey && !$enable_projecttype_singlesurveyforms && !$enable_projecttype_forms) { ?>
		...
		$('#step1').append('<span style="color:#800000;"><img src="'+app_path_images+'exclamation.png"> <?php echo cleanHtml($lang['system_config_155']) ?></span>');
		$('#step2').hide();
...
<tr valign="top">
	...
	<td>
		<input name="app_title" id="app_title" type="text" style="width:95%;max-width:450px;" class="x-form-text x-form-field" onkeydown="if(event.keyCode==13){return false;}">
		<div class="newdbsub">
...
<tr id="row_project_note">
	...
	<textarea class="x-form-textarea x-form-field" id="project_note" name="project_note" style="height:34px;width:95%;max-width:450px;"><?php if(isset($project_note)){ ?><?php echo $project_note ?><?php } ?></textarea>
	</td>
</tr>
