...
callJSfile('velocity-ui-min.js');
callJSfile('ToDoList.js');
//sorting
if (isset($_GET['sort'])){
  $sort = $_GET['sort'];
...
<div style="position:relative;" data-debug=<?php echo 'debugger'?>>
  <h4 class="page-title"><?php echo RCView::img(array('src'=>'checklist_flat.png')) . $lang['dashboard_111'] ?></h4>
  <div class="toggle-email-notifications-wrapper">
	...
	(<a href="javascript:;" style="text-decoration:underline;color:#666;font-size:11px;" onclick="simpleDialog('<?php echo cleanHtml($lang['control_center_4541']) ?>','<?php echo cleanHtml($lang['control_center_4533']) ?>');"><?php echo $lang['ws_22'] ?></a>)
  </div>
