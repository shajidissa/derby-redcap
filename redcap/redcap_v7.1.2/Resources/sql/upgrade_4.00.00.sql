...
(concat('redcap_demo_',LEFT(MD5(RAND()),6)), @project_title, 1, 0, 'none', now(), now(), @institution, @site_org_type, @grant_cite, @project_contact_name, @project_contact_email, @headerlogo, 2, 1);
