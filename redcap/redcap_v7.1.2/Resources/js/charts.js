...
function downloadImgViaDataUrl(chartContainerId,field) {
	...
	var formHtml = '<form action="'+app_path_webroot+'Graphical/image_base64_download.php?pid='+pid+'&field='+field+'" '
				 ...
				 + '<input type="hidden" name="redcap_csrf_token" value="'+redcap_csrf_token+'"></form>';
...
if (window['google'] != undefined && window['google']['loader'] != undefined) {
	...
	google.loader.writeLoadTag("script", app_path_webroot+"Resources/js/corechart.js", false);
}