...
<p>
	...
	<?php echo $lang['esignature_26'] ?> <img src="<?php echo APP_PATH_IMAGES ?>tick_shield.png" style="vertical-align:middle;">
	<span style="color:#008000;font-weight:bold;"><?php echo $lang['global_34'] ?></span>, <?php echo $lang['esignature_28'] ?>
	<img src="<?php echo APP_PATH_IMAGES ?>lock.png" style="vertical-align:middle;">
