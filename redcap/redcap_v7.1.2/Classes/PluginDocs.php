...
class PluginDocs
{
	...
	public static function displayPluginMethods()
	{
		...
		elseif (isset($_GET['page']) && $_GET['page'] == 'faq_plugins') {
			...
			$html .= RCView::h3(array(), "Plugin FAQ (Frequently Asked Questions)") . ob_get_clean();
		}
		// FAQ for Hooks
		elseif (isset($_GET['page']) && $_GET['page'] == 'faq_hooks') {
			ob_start();
			include APP_PATH_DOCROOT . "Plugins/faq_hooks.php";
			$html .= RCView::h3(array(), "Hook FAQ (Frequently Asked Questions)") . ob_get_clean();
		}
		// redcap_info()
		...
		<head>
			<meta http-equiv="content-type" content="text/html; charset=UTF-8">
			<title>REDCap Plugin & Hook Documentation</title>
			<meta name="googlebot" content="noindex, noarchive, nofollow, nosnippet">
			<meta name="robots" content="noindex, noarchive, nofollow">
			<meta name="slurp" content="noindex, noarchive, nofollow, noodp, noydir">
			<meta name="msnbot" content="noindex, noarchive, nofollow, noodp">
		...
		<div class="rcproject-navbar navbar navbar-default navbar-fixed-top" role="navigation">
			<div class="container">
				<div class="navbar-header">
					<span class="navbar-brand" style="max-width:78%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">Plugin & Hook Documentation</span>
		...
		<div class="center container-fluid" style="margin:0;padding:0;">
		<table style="max-width:1050px;">
			<tr>
				<td id="left-menu" class="h hidden-xs col-sm-4" valign="top" style="width:240px;padding:10px 10px 100px;">
					<!-- Logo -->
					<div class="hidden-xs" style="margin:10px 0 15px;">
					...
					<div class="hideIE8 hidden-sm hidden-md hidden-lg" style="margin-top:60px;"></div>
					...
					<?php } ?>
					<!-- Basics Links -->
					<h5 style="margin-top:15px;font-weight:bold;">Plugins & Hooks</h5>
				...
				<!-- Main content window -->
				<td valign="top" class="col-xs-12 col-sm-8" style="padding:10px 10px 10px;border:0;">
					<div class="h hidden-xs" style="padding:10px 10px;border:1px solid #000;margin:0 0 20px;">
						<h3 style="font-weight:bold;margin:0;">REDCap Developer Tools &mdash; Plugin & Hook Documentation</h3>
			...
			<!-- Footer -->
			<tr>
				<td colspan="2" class="col-xs-12" style="padding:20px 0;border:0;color:#aaa;text-align:center;font-size:12px;">
